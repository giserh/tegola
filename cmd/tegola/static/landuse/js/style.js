function createMapboxStreetsV6Style() {
  ...
  if (layer == 'debug' && type == 'debug_outline'){
    ...
    //  local styles
    if (layer == "parcels"){
      stroke.setColor('rgba(0,0,255,0.8)');
      stroke.setWidth(1);
      styles[length++] = line;
    } else if (layer == 'zoning' && cls == "zone"){
      stroke.setColor('rgba(0,255,0,0.8)');
      stroke.setWidth(1);
      styles[length++] = line;
    } else if(layer == 'counties' && cls == "county"){
      stroke.setColor('rgba(255,0,0,0.8)');
      stroke.setWidth(1);
      styles[length++] = line;
    } else if (layer == 'county_names') {
      ...
      stroke.setWidth(2);
      styles[length++] = text;
    } else if (layer == 'states' && cls == "state") {
      stroke.setColor('rgba(255,0,0,0.8)');
      stroke.setWidth(1);
      styles[length++] = line;
    } else if (layer == 'state_names') {
      text.getText().setText(feature.get('name'));
      text.getText().setFont('bold 11px "Open Sans", "Arial Unicode MS"');
      fill.setColor('#334');
      stroke.setColor('rgba(255,255,255,0.8)');
